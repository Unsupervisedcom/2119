...
3. The documentation MUST explain that annotation-block hashing avoids unrelated verdict churn while configured shared evidence deliberately invalidates dependent verdicts to preserve helper integrity, and that anti-accretion rollout is guidance and observational reporting rather than automatic test deletion or metric-based gating. [review: README.md, docs/scaling.md]
