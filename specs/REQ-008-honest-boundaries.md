...
3. `docs/design.md` MUST record why verdict provenance fields were rejected (self-reported provenance is unenforceable decoration) and name the independent-runner pattern, where a CI identity the author cannot impersonate records the verdicts, as the supported trust boundary. [review: docs/design.md]
